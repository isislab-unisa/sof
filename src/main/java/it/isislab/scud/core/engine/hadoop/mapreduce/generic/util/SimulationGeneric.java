...
public class SimulationGeneric {
	...
	public void run(String program_path,String input,
		...
		String SIM_EXECUTABLE_SIMULATION_PROGRAM = conf.get("simulation.program.simulation");
		...
		String[] inputSimulation = new String[aparam.length];
		...
		Process process;
		process = Runtime.getRuntime().exec(SIM_EXECUTABLE_SIMULATION_PROGRAM);
		process.waitFor();
