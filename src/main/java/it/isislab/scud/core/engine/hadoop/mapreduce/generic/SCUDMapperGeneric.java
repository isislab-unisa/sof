 ...
 *
 */
public class SCUDMapperGeneric extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>/*input key type, input value type, output key type, output value type*/{
