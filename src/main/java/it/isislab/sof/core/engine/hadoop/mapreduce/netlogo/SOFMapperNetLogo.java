 ...
 *
 */
package it.isislab.sof.core.engine.hadoop.mapreduce.netlogo;

import it.isislab.sof.core.engine.hadoop.mapreduce.netlogo.util.SimulationNETLOGO;
 ...
 *
 */
public class SOFMapperNetLogo extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>/*input key type, input value type, output key type, output value type*/{
