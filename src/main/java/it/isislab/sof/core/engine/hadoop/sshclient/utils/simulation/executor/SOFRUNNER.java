...
import it.isislab.sof.core.engine.hadoop.sshclient.utils.selection.SelectionFunction;
...
import it.isislab.sof.core.model.parameters.xsd.message.Messages;
...
public class SOFRUNNER{
	...
	public static Logger log = Logger.getLogger(SOFRUNNER.class.getName());
