 ...
 */
package core.engine.hadoop.mapreduce.mason;
...
import core.engine.hadoop.mapreduce.mason.util.SimulationMASON;

/**
 * Mapper Class for SCUD
 * 
 * @author Michele Carillo, Flavio Serrapica, Franceco Raia
 *
 */
public class SCUDMapperMason extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>/*input key type, input value type, output key type, output value type*/{
